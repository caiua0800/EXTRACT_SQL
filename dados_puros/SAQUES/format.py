...
def format_data(data):
    ...
    for entry in data:
        formatted_entry = {
            ...
            'VALORSACADO': entry.get('total_value')
        }
...
if __name__ == "__main__":
    ...
    input_file = 'VALOR_SACADO_INPUT.json'  # Substitua pelo nome do seu arquivo JSON de entrada
    ...
    output_file = os.path.join(output_dir, 'VALOR_SACADO_OUTPUT.json')
